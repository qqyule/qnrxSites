<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.BackgroundPages.Cms.PageContentAdd" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <script type="text/javascript" src="../assets/validate.js?v=6.7.6"></script>
    <script type="text/javascript" src="../assets/jquery/jquery.form.js?v=6.7.6"></script>
    <script type="text/javascript" src="../assets/jscolor/jscolor.js?v=6.7.6"></script>
    <script>
