<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Cms.ModalCuttingImage" Trace="false" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="js/jquery.imgareaselect/css/imgareaselect-default.css?v=6.7.6" />
      <script type="text/javascript" src="js/jquery.imgareaselect/scripts/jquery.imgareaselect.pack.js?v=6.7.6"></script>
      <script type="text/javascript" src="js/jQueryRotateCompressed.js?v=6.7.6"></script>
