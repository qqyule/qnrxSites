<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.PageInstaller" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <head>
      ...
      <link href="../assets/showLoading/css/showLoading.css?v=6.7.6" rel="stylesheet" />
      <script type="text/javascript" src="../assets/showLoading/js/jquery.showLoading.js?v=6.7.6"></script>
      <link href="password.css?v=6.7.6" rel="stylesheet" />
      <script type="text/javascript" src="password.js?v=6.7.6"></script>
    </head>
